...
/**
 * GitHubConnectCard — builder portal card for GitHub identity verification.
 * If GitHub not connected: shows "Connect GitHub" button.
 * If connected: shows green checkmark + GitHub username.
 */
...
export default function GitHubConnectCard({ githubUsername }: GitHubConnectCardProps) {
  return (
    <div
