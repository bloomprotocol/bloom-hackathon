  ...
  return (
    <footer className="bg-[#0b0d0c] w-full overflow-hidden">
      ...
      <div className="bg-black relative">
        {/* Gradient overlay */}
        <div className="absolute inset-x-0 top-0 h-[140px] bg-gradient-to-b from-black to-transparent" />
        
        {/* Content */}
        <div className="relative flex flex-col items-center justify-center py-12 desktop:py-[83px] px-4">
          <div className="flex flex-col items-center gap-6 opacity-[0.844]">
            ...
            {/* Main tagline */}
            <h2 className="text-[23px] desktop:text-[40px] font-['Outfit'] font-medium text-[#f1fff4] text-center leading-[23px] desktop:leading-[40px] tracking-[-1.12px] desktop:[text-shadow:rgba(255,255,255,0.5)_0px_0px_10px]">
              Early Capital Formation Layer
            </h2>
            
            {/* Sub tagline */}
            <p className="text-[20px] font-['Outfit'] font-light text-[#f1fff4] text-center tracking-[-0.4px]">
      ...
      {/* Main Footer Section */}
      <div className="max-w-[1440px] w-full mx-auto px-4 desktop:px-[52px]">
